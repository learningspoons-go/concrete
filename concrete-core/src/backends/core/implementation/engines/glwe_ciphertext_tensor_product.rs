...
use crate::prelude::{GlweCiphertextTensorProductEngine, GlweCiphertextTensorProductError, CleartextF64};
use crate::specification::entities::GlweCiphertextEntity;

/// # Description:
/// Implementation of [`GlweTensorProductEngine`] for [`CoreEngine`] that operates on 32-bit
/// integer Glwe Ciphertexts.
impl GlweCiphertextTensorProductEngine<GlweCiphertext32, GlweCiphertext32, GlweCiphertext32, CleartextF64>
    for CoreEngine
{
...
/// integer Glwe Ciphertexts.
impl GlweCiphertextTensorProductEngine<GlweCiphertext64, GlweCiphertext64, GlweCiphertext64, CleartextF64>
    for CoreEngine
{
    fn tensor_product_glwe_ciphertext(
        &mut self,
