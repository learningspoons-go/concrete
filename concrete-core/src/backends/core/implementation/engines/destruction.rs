...
impl DestructionEngine<LweSecretKey32> for CoreEngine {
    ...
    unsafe fn destroy_unchecked(&mut self, _entity: &LweSecretKey32) {}
}
...
impl DestructionEngine<LweSecretKey64> for CoreEngine {
    ...
    unsafe fn destroy_unchecked(&mut self, _entity: &LweSecretKey64) {}
}
...
impl DestructionEngine<GlweSecretKey32> for CoreEngine {
    ...
    unsafe fn destroy_unchecked(&mut self, _entity: &GlweSecretKey32) {}
}
...
impl DestructionEngine<GlweSecretKey64> for CoreEngine {
    ...
    unsafe fn destroy_unchecked(&mut self, _entity: &GlweSecretKey64) {}
}
