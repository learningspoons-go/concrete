...
/// |\vec{s}_{\mathsf{in}}|$ and $n_{\mathsf{out}} = |\vec{s}_{\mathsf{out}}|$, such that the noise
...
/// $$ \mathsf{PBS}\left(\mathsf{ct}_{\mathsf{in}} , \mathsf{BSK} \right) \rightarrow
...
/// - $\mathsf{BSK}_{\vec{s}_{\mathsf{in}}\rightarrow \vec{S}_{\mathsf{out}}}$: a bootstrapping key
///   as defined above
...
/// N_{\mathsf{out}} \cdot a_i}{q} \rceil$, for $i= 0, 1, \ldots, n_{\mathsf{in}-1}$ 2. Compute
/// $\tilde{b}_\mathsf{in} \in \mathbb{Z}_{2N_{\mathsf{out}}} \leftarrow \lfloor \frac{2
/// N_{\mathsf{out}} \cdot b_\mathsf{in}}{q} \rceil$ 3. Set $\mathsf{ACC} = (0, \ldots, 0,
...
/// \mathsf{ACC})$, for $i= 0, 1, \ldots, n_{\mathsf{in}-1}$ 5. Output $\mathsf{ct}_{\mathsf{out}}
